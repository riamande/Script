...
sendemail -f statistic@kaskusnetworks.com -t glen@kaskusnetworks.com,rully@kaskusnetworks.com,rina.tantri@kaskusnetworks.com,ignatius.untung@kaskusnetworks.com  -u "WEEKLY STATISTIC" -m "STATISTIC PER $lastweek_date s/d $tanggal_date \n\n\n Details information is attached below. \n\n\n\n Regards, \n DBA" -a $url/"Report_"$tanggal"_"$condition.csv -s 172.16.0.5 > /dev/null  2>&1
