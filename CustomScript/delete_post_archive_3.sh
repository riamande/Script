for i in `cat temp_archive/log_post_todelete.log1aa`
do
...
for k in `cat temp_archive/log_post_todelete.log1ab`
do
...
for m in `cat temp_archive/log_post_todelete.log1ac`
do
