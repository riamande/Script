...
echo "mongo $kaskus_misc/kaskus_user_log --eval 'rs.slaveOk();db.userloginlog.count({datetime:{\$lte:\"$tanggal_date\",\$gte:\"$lastweek_date\"}})'" >> $temp_mongo_script/tempmongoscript.sh

echo "/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'a=ObjectId();b=db.post.findOne({dateline:{\$gte:$lastweek}},{_id:1});db.post.count({_id:{\$lte:a,\$gte:b._id}})'" >> $temp_mongo_script/tempmongoscript.sh

echo "/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.count({forum_id:{\$nin:[$fjb_id]},last_post:{\$gte:$lastweek,\$lte:$tanggal}})'" >> $temp_mongo_script/tempmongoscript.sh

echo "/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.count({forum_id:{\$in:[$fjb_id]},last_post:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"WTS\"})'" >> $temp_mongo_script/tempmongoscript.sh

echo "/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.count({forum_id:{\$in:[$fjb_id]},last_post:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"WTB\"})'" >> $temp_mongo_script/tempmongoscript.sh

echo "/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.count({forum_id:{\$in:[$fjb_id]},last_post:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:{\$nin:[\"WTS\",\"WTB\"]}})'" >> $temp_mongo_script/tempmongoscript.sh                          

echo "/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.count({forum_id:{\$nin:[$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal}})'" >> $temp_mongo_script/tempmongoscript.sh

echo "/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.count({forum_id:{\$in:[$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"WTS\"})'" >> $temp_mongo_script/tempmongoscript.sh                          

echo "/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.count({forum_id:{\$in:[$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"WTB\"})'" >> $temp_mongo_script/tempmongoscript.sh

echo "/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.count({forum_id:{\$in:[$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:{\$nin:[\"WTS\",\"WTB\"]}})'" >> $temp_mongo_script/tempmongoscript.sh

echo "var hasil = 0; var x = db.thread.find({forum_id:{\$in: [$fjb_id]},last_post:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"WTS\"},{_id:1});for(i=0;i<x.length();i++){ try{hasil += db.post.find({hash_thread_id:hex_md5(x[i]['_id'].str),dateline:{\$gte:$lastweek,\$lte:$tanggal}}).count();}catch(err){} }; db.report.save({dateline:$tanggal,type:\"active wts\",total:hasil});" >> $temp_mongo_script/tempmongoreport.JSON
...
echo "var hasil = 0; var x = db.thread.find({forum_id:{\$in: [$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"WTS\"},{_id:1});for(i=0;i<x.length();i++){ try{hasil += db.post.find({hash_thread_id:hex_md5(x[i]['_id'].str)}).count();}catch(err){} }; db.report.save({dateline:$tanggal,type:\"new wts\",total:hasil});" >> $temp_mongo_script/tempmongoreport.JSON

echo "var hasil = 0; var x = db.thread.find({forum_id:{\$in: [$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"WTB\"},{_id:1});for(i=0;i<x.length();i++){ try{hasil += db.post.find({hash_thread_id:hex_md5(x[i]['_id'].str)}).count();}catch(err){} }; db.report.save({dateline:$tanggal,type:\"new wtb\",total:hasil});" >> $temp_mongo_script/tempmongoreport.JSON

echo "var hasil = 0; var x = db.thread.find({forum_id:{\$in: [$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:{\$nin:[\"WTS\",\"WTB\"]}},{_id:1});for(i=0;i<x.length();i++){ try{hasil += db.post.find({hash_thread_id:hex_md5(x[i]['_id'].str)}).count();}catch(err){} }; db.report.save({dateline:$tanggal,type:\"new misc\",total:hasil});" >> $temp_mongo_script/tempmongoreport.JSON

echo "var hasil = 0; var x = db.thread.find({forum_id:{\$nin:[$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal}},{_id:1});for(i=0;i<x.length();i++){ try{hasil += db.post.find({hash_thread_id:hex_md5(x[i]['_id'].str)}).count();}catch(err){} }; db.report.save({dateline:$tanggal,type:\"new forum\",total:hasil});" >> $temp_mongo_script/tempmongoreport.JSON
...
/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 $temp_mongo_script/tempmongoreport.JSON

temp_ttl_pub_replies_wts=`/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.report.find({dateline:'$tanggal',type:"active wts"},{total:1,_id:0}).forEach(printjson)' |sed -n 3p |sed -e 's/ //g' |cut -d':' -f2 |cut -d'}' -f1`

temp_ttl_pub_replies_wtb=`/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.report.find({dateline:'$tanggal',type:"active wtb"},{total:1,_id:0}).forEach(printjson)' |sed -n 3p |sed -e 's/ //g' |cut -d':' -f2 |cut -d'}' -f1`

temp_ttl_pub_replies_misc=`/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.report.find({dateline:'$tanggal',type:"active misc"},{total:1,_id:0}).forEach(printjson)' |sed -n 3p |sed -e 's/ //g' |cut -d':' -f2 |cut -d'}' -f1`

temp_ttl_new_replies_wts=`/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.report.find({dateline:'$tanggal',type:"new wts"},{total:1,_id:0}).forEach(printjson)' |sed -n 3p |sed -e 's/ //g' |cut -d':' -f2 |cut -d'}' -f1`

temp_ttl_new_replies_wtb=`/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.report.find({dateline:'$tanggal',type:"new wtb"},{total:1,_id:0}).forEach(printjson)' |sed -n 3p |sed -e 's/ //g' |cut -d':' -f2 |cut -d'}' -f1`

temp_ttl_new_replies_misc=`/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.report.find({dateline:'$tanggal',type:"new misc"},{total:1,_id:0}).forEach(printjson)' |sed -n 3p |sed -e 's/ //g' |cut -d':' -f2 |cut -d'}' -f1`

temp_ttl_new_replies_forum=`/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.report.find({dateline:'$tanggal',type:"new forum"},{total:1,_id:0}).forEach(printjson)' |sed -n 3p |sed -e 's/ //g' |cut -d':' -f2 |cut -d'}' -f1`

temp_ttl_user_thread_forum=`/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.distinct("post_userid",{forum_id:{$nin:['$fjb_id']},dateline:{$gte:'$lastweek',$lte:'$tanggal'}}).forEach(printjson)' |grep -v MongoDB |grep -v connecting |wc -l`

temp_ttl_user_thread_fjb=`/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.distinct("post_userid",{forum_id:{$in:['$fjb_id'],dateline:{$gte:'$lastweek',$lte:'$tanggal'}}).forEach(printjson)' |grep -v MongoDB |grep -v connecting |wc -l`

/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.distinct("_id",{forum_id:{$nin:['$fjb_id']},dateline:{$gte:'$lastweek',$lte:'$tanggal'}}).forEach(printjson)' |grep -v MongoDB |grep -v connecting |sed -e 's$ObjectId($$g'|sed -e 's$)$$g' > $temp_mongo_script/list_thread_forum.log

/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval 'db.thread.distinct("_id",{forum_id:{$in:['$fjb_id']},dateline:{$gte:'$lastweek',$lte:'$tanggal'}}).forEach(printjson)' |grep -v MongoDB |grep -v connecting |sed -e 's$ObjectId($$g'|sed -e 's$)$$g' > $temp_mongo_script/list_thread_fjb.log

for f in `cat $temp_mongo_script/list_thread_forum.log`
do
/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval "db.post.distinct('post_userid',{hash_thread_id:hex_md5('$f')}).forEach(printjson)" |grep -v MongoDB |grep -v connecting |sed -e 's/"//g' >> $temp_mongo_script/temp_ttl_usr_forum.log
...
do
/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval "db.post.distinct('post_userid',{hash_thread_id:hex_md5('$h')}).forEach(printjson)" |grep -v MongoDB |grep -v connecting |sed -e 's/"//g' >> $temp_mongo_script/temp_ttl_usr_fjb.log
...
TOTAL_ACTIVE_USER=`mysql -h 


172.20.0.73 -u$MYSQL_USER -p$MYSQL_PASS forum -N -s -e"select count(*) from forum_user_setting where (lastpost_time>=$lastweek and lastpost_time<=$tanggal) or (lastthread_time>=$lastweek and lastthread_time<=$tanggal);"`
...
/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval "db.thread.count({forum_id:{\$in:[$fjb_id]}})" |grep -v "MongoDB shell version:" |grep -v "connecting to: kaskus_forum1" > $temp_mongo_script/ttl_fjb_all.log
M_TOTAL_FJB=`cat $temp_mongo_script/ttl_fjb_all.log`
#total new item added(taged new from wts)
/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval "db.thread.count({forum_id:{\$in:[$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"WTS\",item_condition:1})" |grep -v "MongoDB shell version:" |grep -v "connecting to: kaskus_forum1" > $temp_mongo_script/ttl_fjb_tag_new.log
M_TOTAL_FJB_TAG_NEW=`cat $temp_mongo_script/ttl_fjb_tag_new.log`
#total second item added(taged second from wts)
/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval "db.thread.count({forum_id:{\$in:[$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"WTS\",item_condition:1})" |grep -v "MongoDB shell version:" |grep -v "connecting to: kaskus_forum1" > $temp_mongo_script/ttl_fjb_tag_scnd.log
...
#total sold item
/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval "db.thread.count({forum_id:{\$in:[$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"SOLD\"})" |grep -v "MongoDB shell version:" |grep -v "connecting to: kaskus_forum1" > $temp_mongo_script/ttl_fjb_sold.log
M_TOTAL_SOLD=`cat $temp_mongo_script/ttl_fjb_sold.log`
#uniq seller based on WTS thread
/opt/mongodb_3.0.10/bin/mongo 127.0.0.1:27018/kaskus_forum -uforumshardrw -pG5NVEI5WkLFgGTB1 --eval "db.thread.distinct(\"post_userid\",{forum_id:{\$in:[$fjb_id]},dateline:{\$gte:$lastweek,\$lte:$tanggal},prefix_id:\"WTS\"}).forEach(printjson)" |grep -v "MongoDB shell version:" |grep -v "connecting to: kaskus_forum1" |wc -l > $temp_mongo_script/ttl_uniq_seller.log
...
echo $reportweek/"$condition"_forumreport_$tanggal".txt" >> $temp_mongo_script/"$condition"_filesummary.log
echo $reportweek/"$condition"_fjbreport_$tanggal".txt" >> $temp_mongo_script/"$condition"_filesummary.log
echo $reportweek/"$condition"_demographicreport_$tanggal".txt" >> $temp_mongo_script/"$condition"_filesummary.log
echo $reportweek/"$condition"_marketing_$tanggal".txt" >> $temp_mongo_script/"$condition"_filesummary.log
...
sendemail -f statistic@kaskusnetworks.com -t db@kaskusnetworks.com,resty.fauziah@kaskusnetworks.com,hilda@kaskusnetworks.com,sista.wulandari@kaskusnetworks.com,zarona@kaskusnetworks.com,elsa@kaskusnetworks.com,rae.mandela@kaskusnetworks.com,ecky.putrady@gdplabs.id,farman.kosim@gdplabs.id,glen@kaskusnetworks.com,rully@kaskusnetworks.com -u "WEEKLY STATISTIC" -m "STATISTIC PER $lastweek_date s/d $tanggal_date \n\n\n Details information is attached below. \n\n\n\n Regards, \n DBA" -a $reportweek/"$condition"_report_"$tanggal".txt -o tls=no -s 103.6.117.20 > /dev/null  2>&1
mv $temp_mongo_script/"$condition"_filesummary.log $temp_mongo_script/"$condition"_filesummary.temp
fi

/home/rully/check_mailsend.sh $condition $tanggal $lastweek
